...
public class FornecedorPaneController {
	...
	public void alterarFornecedor()
			throws FornecedorNaoExisteException, FormatacaoInvalidaException, ValidationException, IOException {
	...
	private void initialize() {
		...
		colunaEndereco
				.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getEnderecoFornecedor()));
	...
	private boolean validateFields() throws IOException {
		...
		try {
			if ((txtNomeFornecedor.getText().isEmpty() || !txtNomeFornecedor.getText().matches("[a-z A-Z]+"))
					|| txtEnderecoFornecedor.getText().isEmpty() || txtCodigoFornecedor.getText().isEmpty()
					|| (txtTelefoneFornecedor.getText().isEmpty() || !txtTelefoneFornecedor.getText()
