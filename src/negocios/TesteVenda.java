...
public class TesteVenda {
	...
	public static void main(String[] args) throws FormatacaoInvalidaException {
		 ...
		 * 
		 * System.out.print(""+panelaFit.listarVendas()); try{
		 * panelaFit.removerVenda(venda1); }catch(Exception e) {
		 * e.printStackTrace(); System.out.println("\n"); }
		 * System.out.print(""+panelaFit.listarVendas());
		 * 
		 * try{ panelaFit.buscarVenda(456); }catch(Exception e) {
		 * e.printStackTrace(); System.out.println("\n"); }
		 * 
		 * try{ panelaFit.cadastrarVenda(venda2); } catch(Exception e) {
		 * e.printStackTrace(); System.out.println("\n"); } /* try{
		 * panelaFit.cadastrarVenda(venda2); }catch (Exception e){
		 * e.printStackTrace(); System.out.println(); }
		 * 
		 * try{ panelaFit.buscarVenda(123); }catch (Exception e){
		 * e.printStackTrace(); System.out.println(); }
		 * 
		 * try{ panelaFit.buscarVenda(123); }catch (Exception e){
		 * e.printStackTrace(); System.out.println(); }
		 * 
		 * /*try{ panelaFit.cadastrarVenda(venda1); }catch (Exception e){
		 * e.printStackTrace(); System.out.println(); } System.out.println(""
		 * +panelaFit.listarVendas());
		 */
